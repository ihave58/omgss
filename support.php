        ...
        <div class="container">
            <div class="row d-md-flex justify-content-end">
                <div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate heading-section heading-section-white">
                    ...
                    <h2 class="mb-4">For any Support feel free to contact</h2>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea cols="30" rows="5" rows="4" cols="50" class="form-control" name="message"
                                              placeholder="Tell Us what kind of support you need, We are here to help you."></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="submit" value="Submit" name="btnsupport"
