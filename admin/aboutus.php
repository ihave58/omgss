                            ...
                            <form enctype="multipart/form-data" method="post">
                                ...
                                <p>
                                    ...
                                    <input id="image" name="image" type="file" placeholder="Image"/> <img
                                            src="files/extras/<?php echo $rowabout['image']; ?>"
                                ...
                                <p>
                                    ...
                                    <textarea id="editor1" name="textterms" required="required" type="text"
                                              placeholder="Text"><?php echo $rowabout['textterms']; ?></textarea>
                                </p>


                                <br>
                                <p class="signin button">
                                    <input type="submit" name="aboutbtn" class="btn btn-primary" value="Add"/>
                                </p>
                                <!-- <p class="change_link">  
