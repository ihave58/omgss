                            ...
                            <form enctype="multipart/form-data" method="post">
                                ...
                                <p>
                                    ...
                                    <input id="image" name="image" type="file" placeholder="Image"/> <img
                                            src="files/extras/<?php echo $rowprivacy['image']; ?>"
                                ...
                                <p>
                                    ...
                                    <textarea id="editor1" name="textterms" required="required" type="text"
                                              placeholder="Text"><?php echo $rowprivacy['textterms']; ?></textarea>
                                </p>


                                <br>
                                <p class="signin button">
                                    <input type="submit" name="privacybtn" class="btn btn-primary" value="Add"/>
                                </p>
                                <!-- <p class="change_link">  
