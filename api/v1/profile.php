<?php
    ...
    if ($method == 'POST') {
        $loggedinuserid = (isset($_POST['loggedinuserid'])) ? runUserInputSanitizationHook($_POST['loggedinuserid']) : '';
        ...
        $getresult = "SELECT * FROM 005_omgss_users WHERE id='" . $loggedinuserid . "'";
