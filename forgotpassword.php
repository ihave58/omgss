...
include('header.php');
?>
<section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb img" style="background-image: url(images/forgotpw.jpg);    margin-bottom: 10px;">
    			...
    			<div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate heading-section heading-section-white">
    				...
    				<form method="post" class="appointment">
    					<div class="row">
								...
								<div class="col-md-12">
								<div class="form-group">
			              			<input type="submit" value="Reset Password" name="respass" class="btn btn-dark py-3 px-4">
			            		</div>
								</div>
    					</div>
	          </form>
